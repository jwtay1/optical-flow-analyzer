...
vid = VideoWriter('D:\Work\Motion UI\data\test\const_12047_1_001.avi');
vid.FrameRate = 10;
open(vid)

%TODO: Filter incorrect correlations, Add in maximum pixel motion analysis.

for iT = 2:20%reader.sizeT
    
    Inext = getPlane(reader, 1, 1, iT);
